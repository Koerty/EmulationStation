...
* `tileMaxSize` - type: NORMALIZED_PAIR.
    - The maximum size a tile can take.
* `selectedTileMaxSize` - type: NORMALIZED_PAIR.
    - The maximum size of the selected tile. Default value if not defined by the theme is `tileMaxSize * 1.15`
